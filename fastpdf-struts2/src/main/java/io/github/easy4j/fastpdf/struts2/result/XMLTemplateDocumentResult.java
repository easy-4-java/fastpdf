package io.github.easy4j.fastpdf.struts2.result;
...
import com.jeefw.fastpdf.core.document.render.PDFDocumentRender;
...
public class XMLTemplateDocumentResult extends StrutsResultSupport {
	...
	protected static Logger LOG = LoggerFactory.getLogger(XMLTemplateDocumentResult.class);
